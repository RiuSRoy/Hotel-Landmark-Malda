...
export default function About() {
    return (
      <>
        <h1 className={`text-center pt-24 text-6xl ${header.className}`}>Hotel Landmark Malda</h1>
        <h1 className="text-center pb-12 text-3xl">One of the best hotels in Malda</h1>
        <div className="grid grid-col-1 md:grid-cols-2 xl:grid-cols-3 gap-12 text-xl text-justify">
            ...
            <Image src="/10-dr.jpeg" width={500} height={500} alt="Banquet halls for parties in Malda"/>
            ...
            <p className="text-lime-800 mx-12">We are located just minutes from the main market attraction of Malda. Our housekeeping staff family are specially trained to meet every need of yours at any hour of the day. All our guests keep raving about the amazingly awesome behaviour of all our staff making it the 
            <Link className='text-indigo-500 font-bold underline-offset-8 underline' href="https://www.google.com/search?q=Hotel+Landmark+Malda&stick=H4sIAAAAAAAA_-NgU1I1qDC2TEtMSzFIMbBISk0ysEizAgpZJCaZm5qlJqcYpSUnmRovYhXxyC9JzVHwScxLyU0sylbwTcxJSQQAcoGI0UAAAAA&hl=en&mat=CZCCwmLOEYETElcBl7_Ll0EajnY54NBodbnY9sB-lWKSrZvBhd9FmVP-fSa-m4fVRCAQ-JoefqG17xdXJwnjuTZR-AyAf40R-Ja_o7WqGKrNHhO9ArcuNep8lW7HWgYvN9c&authuser=0"> best hotel in malda</Link></p>
            
            <Image src="/1.jpeg" width={500} height={500} alt="Banquet halls with catering in Malda"/>
            ...
            <p className="text-amber-800 mx-12">Check our
              <Link href="/banquet-malda-wb" className='text-indigo-500 font-bold underline-offset-8 underline'> state of the art banquet</Link>
              
            . Our team is dedicated to crafting the ideal setting for your special moments, ensuring that every detail is meticulously planned to exceed your expectations.</p>
        </div>
      </>
    )
}